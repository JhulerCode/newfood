...
export default {
    ...
    created() {
        this.vista = this.useVistas.vImpresionAreas
        this.useAuth.setColumns(this.tableName, this.columns)

        if (this.vista.loaded) return

        if (this.useAuth.verifyPermiso('vImpresionAreas:listar') == true) this.loadCajas()
    },
    methods: {
        setQuery() {
            this.vista.qry = {
        ...
        async eliminar(item) {
            ...
            this.useVistas.removeItem('vImpresionAreas', 'produccion_areas', item)
        },
    },
}
</script>
